...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_replaceChild_708a63be18c12f97 = function() { return handleError(function (arg0, arg1, arg2) {
        const ret = getObject(arg0).replaceChild(getObject(arg1), getObject(arg2));
        return addHeapObject(ret);
    }, arguments) };
    imports.wbg.__wbg_instanceof_Comment_7e6154347a69c934 = function(arg0) {
        let result;
        try {
    ...
    imports.wbg.__wbg_instanceof_Text_52643a49dab8e0a8 = function(arg0) {
        let result;
        try {
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('sycamore-bootstrap-template-367c9648e1898e10_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
